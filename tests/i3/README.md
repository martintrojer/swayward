...
| `156-fullscreen-focus.t` | 64 | 59 pass; 1 fail; 4 unproven | Fullscreen focus barriers, nested-container traversal, direct focus unfullscreening, and global mode match sway (`sway/commands/focus.c:88-220,405-412`; `sway/tree/container.c:587-605,1200-1339`). Assertions 40–43 inspect the child count below i3's fullscreen split after workspace moves; sway serializes no equivalent wrapper (`sway/sway/ipc-json.c:532-540,854-893`), so their count remains unproven. Assertion 54 still exposes incorrect focus when leaving a floating-origin fullscreen window for the tiling layer. |
