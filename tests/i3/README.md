...
| `135-floating-focus.t` | 82 | fail (53 pass) | Five failures are rejected sway-supported commands: `focus tiling`, `focus floating`, and `focus mode_toggle` (`sway/commands/focus.c:273-302,418-425`). Other failures cover directional floating focus (`focus.c:225-271,475-485`), focus-child history, floating stacking order, i3-only floating-wrapper traversal, and nested focus restoration. |
