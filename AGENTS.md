...
Prefer new modules. When an inherited niri file must be edited, add a line to
[`docs/DIVERGENCE.md`](docs/DIVERGENCE.md) saying what changed and why.
...
`tests/i3/README.md` is generated from it, and `./contrib/coverage-report
--check` must report 0 violations.
