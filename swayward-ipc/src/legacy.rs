...
pub enum OutputAction {
    ...
    /// Turn on the output.
    On,
    /// Change whether the output is powered.
    Power {
        /// Requested power state.
        power: crate::command::Toggle,
    },
    /// Set the output mode.
    Mode {
        /// Mode to set, or "auto" for automatic selection.
        ///
        /// Run `swayward msg outputs` to see the available modes.
        #[cfg_attr(feature = "clap", arg())]
        mode: ModeToSet,
    },
...
pub struct Workspace {
    ...
    ///
    /// This is the same index you can use for requests like `swayward msg action focus-workspace`.
    ///
