...
pub struct Workspace {
    ...
    /// Sway-compatible ordered output fallbacks; does not pre-create the workspace.
    #[knuffel(child, unwrap(arguments))]
    pub sway_output_assignment: Option<Vec<String>>,
    /// Niri-compatible startup placement, which pre-creates the workspace.
