...
impl<W: LayoutElement> ScrollingSpace<W> {
    ...
    fn activate_column_with_anim_config(&mut self, idx: usize, config: swayward_config::Animation) {
    ...
    pub fn add_column(
        ...
        mut column: Column<W>,
        activate: bool,
        anim_config: Option<swayward_config::Animation>,
    ) {
...
#[cfg(test)]
mod tests {
    use swayward_config::FloatOrInt;
