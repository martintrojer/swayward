...
pub struct DisplayConfig {
    to_niri: calloop::channel::Sender<HashMap<String, Option<swayward_config::Output>>>,
        ...
        for output in self.ipc_outputs.lock().unwrap().values() {
            ...
            if let Some(logical) = output.logical.as_ref() {
                let transform = match logical.transform {
                    swayward_ipc::Transform::Normal => 0,
                    swayward_ipc::Transform::_90 => 1,
                    swayward_ipc::Transform::_180 => 2,
                    swayward_ipc::Transform::_270 => 3,
                    swayward_ipc::Transform::Flipped => 4,
                    swayward_ipc::Transform::Flipped90 => 5,
                    swayward_ipc::Transform::Flipped180 => 6,
                    swayward_ipc::Transform::Flipped270 => 7,
                };
                ...
                new_conf.insert(
                    ...
                    Some(swayward_config::Output {
                        ...
                        transform: match requested_config.transform {
                            ...
                            2 => swayward_ipc::Transform::_180,
                            3 => swayward_ipc::Transform::_270,
                            4 => swayward_ipc::Transform::Flipped,
                            5 => swayward_ipc::Transform::Flipped90,
                            6 => swayward_ipc::Transform::Flipped180,
                            7 => swayward_ipc::Transform::Flipped270,
                            x => {
                                return Err(zbus::fdo::Error::Failed(format!(
                                    "Unknown transform {x}",
                                )))
                        ...
                        position: Some(swayward_config::Position {
                            x: requested_config.x,
                            y: requested_config.y,
                        }),
                        mode: Some(swayward_config::output::Mode {
                            custom: false,
                            mode: swayward_ipc::ConfiguredMode::from_str(&mode).map_err(|e| {
