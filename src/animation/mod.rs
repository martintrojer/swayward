...
impl Animation {
    ...
    pub fn replace_config(&mut self, config: swayward_config::Animation) {
        ...
        match config.kind {
            swayward_config::animations::Kind::Spring(p) => {
            ...
            swayward_config::animations::Kind::Easing(p) => {
                *self = Self::ease(
                    self.clock.clone(),
                    self.from,
                    self.to,
...
impl From<swayward_config::animations::Curve> for Curve {
    fn from(value: swayward_config::animations::Curve) -> Self {
        match value {
            swayward_config::animations::Curve::Linear => Curve::Linear,
            swayward_config::animations::Curve::EaseOutQuad => Curve::EaseOutQuad,
            swayward_config::animations::Curve::EaseOutCubic => Curve::EaseOutCubic,
            swayward_config::animations::Curve::EaseOutExpo => Curve::EaseOutExpo,
            swayward_config::animations::Curve::CubicBezier(x1, y1, x2, y2) => {
