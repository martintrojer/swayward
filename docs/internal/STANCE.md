...
This is an internal working document. It is not published as-is.

**This page owns what swayward says. [`TONE.md`](TONE.md) owns how it
sounds.** Facts, positions and settled answers belong here; register, humour
and sentence-level craft belong there. If they ever disagree, this page wins
on substance and TONE.md wins on wording.
