...
src/layout/mod.rs, src/layout/workspace.rs, src/layout/tile.rs — expose focused-tree layout mutation and direct container focus for sway runtime commands, including sway's parent targeting, workspace-level focus, one-level singleton flatten, and focus-rank preservation across floating transitions.
