...
contrib/sway-to-kdl — translate combined app-id/title criteria and portable border, assignment, floating, layout, focus, and workspace-placement rules without altering regex escapes; fail loudly on X11-only criteria and unsupported rule actions.
