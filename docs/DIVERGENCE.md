...
contrib/sway-to-kdl — translate title-regex assignments and the supported `for_window layout tabbed, focus` subset into native window rules without altering regex escapes.
