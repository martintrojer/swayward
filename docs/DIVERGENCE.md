...
src/layout/mod.rs, src/layout/workspace.rs — expose focused-tree layout mutation and direct container focus for sway runtime commands, including sway's parent targeting and one-level singleton flatten.
