...
src/layout/tiling_tree/mod.rs — apply split commands to an empty workspace root, directional focus by parent layout axis, and MRU focus restoration after removal, matching sway's tree behavior.
