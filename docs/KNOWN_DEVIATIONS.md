...
Sway routes ScreenCast and Screenshot through `xdg-desktop-portal-wlr` in its
shipped portal policy (`sway/sway-portals.conf`). Swayward instead defaults to
...
GTK backend as documented in [Important software](Important-Software.md).
