...
- Dependency example in `swayward-ipc/README.md`
- Dependency example in `swayward-ipc/src/lib.rs`
...
- Run `cargo package -p swayward-ipc` and make sure it succeeds.
...
## Publish the swayward-ipc crate
